      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-emerald-50 leading-relaxed">
            Join hundreds of Indians who've already taken control of their finances and built lasting wealth with our proven mentorship program.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl p-8 lg:p-12">
          ...
          <button className="w-full bg-emerald-600 text-white px-8 py-5 rounded-xl text-lg font-semibold hover:bg-emerald-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group">
            Get Started Now
